...
class Pointnet2MSG(nn.Module):
    ...
    def __init__(self, num_classes=1, input_channels=0, use_xyz=True, bn=True):
        super().__init__()
        ...
        self.FC_layer = nn.Sequential(
            pt_utils.Conv1d(128, 128, bn=bn), nn.Dropout(),
            pt_utils.Conv1d(128, num_classes, activation=None, bn=bn)
        )
    ...
    def forward(self, pointcloud: torch.cuda.FloatTensor):
        ...
        return self.sigmoid(self.FC_layer(l_features[0]).transpose(1, 2).contiguous())
